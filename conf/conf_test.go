...
func TestInitConf_AllEnvVars(t *testing.T) {
	...
	os.Setenv("MILVUS_URL", "milvus:19530")
	...
	assertEqual(t, RagConfInfo.EmbeddingType, "huggingface", "EmbeddingType")
	assertEqual(t, RagConfInfo.EmbeddingBaseURL, "http://hf-embeddings:80", "EmbeddingBaseURL")
	assertEqual(t, RagConfInfo.EmbeddingModelID, "BAAI/bge-small-zh-v1.5", "EmbeddingModelID")
	assertEqual(t, RagConfInfo.EmbeddingQueryInstruction, "为这个句子生成表示以用于检索相关文章：", "EmbeddingQueryInstruction")
	...
	assertEqual(t, RagConfInfo.MilvusURL, "milvus:19530", "MilvusURL")

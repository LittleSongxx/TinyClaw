...
Это руководство объясняет, как настроить переменную окружения **`MCP_CONF_PATH`** при использовании Go-бинарника проекта **`TinyClaw`** для работы с пользовательской конфигурацией MCP-серверов.
...
### 3. Запуск Go-бинарника TinyClaw

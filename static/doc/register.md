...
```bash
./TinyClaw-darwin-amd64 -register_type=etcd -etcd_urls="http://10.0.0.1:2379,http://10.0.0.2:2379" -etcd_username=admin -etcd_password=123456
./TinyClaw-admin-darwin-amd64  -register_type=etcd -etcd_urls="http://10.0.0.1:2379,http://10.0.0.2:2379"
```

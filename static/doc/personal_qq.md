# 🤖 OneBot + TinyClaw Environment Variable Configuration Guide
...
* `3000`: LLONEBot HTTP service port (used to receive messages from TinyClaw)
...
* `3000`: NapCat HTTP service port (used to receive messages from TinyClaw)
...
## ⚙️ 3. TinyClaw Environment Variable Configuration

Before starting TinyClaw, set the following **three environment variables** related to OneBot:

| Variable Name             | Description                                                      | Example Value           |
| ------------------------- | ---------------------------------------------------------------- | ----------------------- |
| `QQ_ONEBOT_RECEIVE_TOKEN` | Token used by OneBot to send messages to TinyClaw (client token)  | `TinyClaw`               |
| `QQ_ONEBOT_SEND_TOKEN`    | Token used by TinyClaw to send messages to OneBot (server token)  | `TinyClaw`               |
...
| ----------------- | ------------------------------------------------- | ------------------------------- |
| **HTTP Server**   | The address TinyClaw uses to call OneBot APIs      | `http://127.0.0.1:3000`         |
| **HTTP Client**   | The address where OneBot pushes message events    | `http://127.0.0.1:36060/onebot` |
| **HTTP Auth Key** | Must match the token set in environment variables | `TinyClaw`                       |

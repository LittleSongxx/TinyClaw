...
func InitConfig() {
	...
	flag.StringVar(&BaseConfInfo.DBConf, "db_conf", botUtils.GetAbsPath("data/tiny_claw_admin.db"), "db conf")
	flag.StringVar(&BaseConfInfo.SessionKey, "session_key", "tiny_claw_session_key", "session key")
	...
	logger.Info("CONF", "SessionKey", maskSecret(BaseConfInfo.SessionKey))
